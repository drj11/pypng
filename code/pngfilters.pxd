...
cdef class BaseFilter:
	...
	cdef unsigned char[::1] now
	@cython.locals(ai = cython.int, i=cython.int, x=cython.uchar, a=cython.uchar)
	cpdef int undo_filter_sub(self, unsigned char[::1] scanline, unsigned char[::1] result)
	...
	cpdef int undo_filter_up(self, unsigned char[::1] scanline, unsigned char[::1] result)
	...
	cpdef int undo_filter_average(self, unsigned char[::1] scanline, unsigned char[::1] result)
	...
	cpdef int undo_filter_paeth(self, unsigned char[::1] scanline, unsigned char[::1] result)
